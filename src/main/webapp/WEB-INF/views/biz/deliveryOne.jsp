				...
				<c:choose>
					...
					<c:otherwise>
						<c:forEach var="deliveryOne" items="${deliveryOne}">
							<tr>
								<td class="text-center">${deliveryOne.deliveryCompany}</td>
								<td class="text-center">${deliveryOne.trackingNo}</td>
								<td class="text-center">${deliveryOne.updateDate}</td>
								<td class="text-center">${deliveryOne.deliveryStatus}</td>
							</tr>
						</c:forEach>
					</c:otherwise>
				</c:choose>
